  ...
  const propiedades_alquiler = [
    ...
    {
        imagen:"https://static1.mansionglobal.com/production/media/article-images/57c4db8cf321138306fe02d668a62e93/large_SEATTLE_EXTERIOR.jpg",
        titulo: "Condominio moderno  Seattle",
        descripcion: "Este elegante condominio esta ubicado en la comunidad mas pujante de Seattle",
        direccion: "144 Main Full Street, Lake, CA 777",
        habitaciones: 3,
        banos: 2,
        precio: 3200,
        Fumar: false,
        ...
        cardsHtml2 += `
          <div class="col-md-4 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">${propiedad2.titulo}</h5>
                <p class="card-text">${propiedad2.descripcion}</p>
                <p><i class="fas fa-map-marker-alt"></i> ${propiedad2.direccion}</p>
